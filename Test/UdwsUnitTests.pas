...
uses Classes, SysUtils,dwsXPlatform, dwsXPlatformTests, dwsComp, dwsCompiler, dwsExprs,
...
begin
   inherited;
   FSaveDS := GetDecimalSeparator; //todo: move to base class
   SetDecimalSeparator('.');
